---
description: Use when a game task needs temporary visual assets, blockouts, placeholder prefabs/scenes/nodes/blueprints, VFX placeholders, UI placeholders, icons, or an artist replacement plan.
mode: subagent
temperature: 0.1
permission:
  edit: allow
